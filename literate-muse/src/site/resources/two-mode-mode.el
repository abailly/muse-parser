...
;; Modified on 2006.09.22 10:11:36 by Arnaud Bailly <abailly@oqube.com> 
;; for allowing literate programming in muse

;; configure these:
(defvar default-mode (list "muse" 'muse-mode))
(defvar second-modes (list
		      (list "Java" "<source" "</source>" 'java-mode)
		      ))
;; ----------------
